...
import Folder from './assets/introduce-folders.png'

import Ca1 from './assets/clean-architecture-1.png'
import Ca2 from './assets/clean-architecture-communication-flow.png'
import Ca3 from './assets/ca-inversion-of-control.png'
import Ca4 from './assets/ca-ours.png'
import Ca5 from './assets/ca-ours2.png'
...
저희 프로젝트는 유지보수를 용이하게 하기 위해 [Clean Architecture](https://blog.coderifleman.com/2017/12/18/the-clean-architecture/)를 일부 적용 했습니다.
...
✋ 각각의 레이어 계층은 임포트의 편리함과, 중복 선언 등을 방지하고자 index 파일에 모아줍니다.
